...
export function signUserToken(userId, email, name, picture) {
  return jwt.sign({ role: 'user', userId, email, name, picture }, JWT_SECRET, { expiresIn: '24h' });
}
...
// Accepts user (Google) tokens; returns payload with userId.
